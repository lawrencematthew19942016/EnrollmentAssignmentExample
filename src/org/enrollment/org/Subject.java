...
public class Subject {
	...
	public String[] subjectName= {"Effective Business Communication", 
			"Foundations of IT", "Foundations of Business", 
			"Programming Concepts", "Maths for IT", 
	...
	public static void main(String[] args) {
		...
		System.out.println(s.getSubjectName()[0]);
}
